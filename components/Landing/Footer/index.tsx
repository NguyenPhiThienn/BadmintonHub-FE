...
export function Footer() {
    return (
        <footer id="footer" className="relative overflow-hidden border-t border-border bg-card">
            ...
            <motion.div
                className="relative mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16"
            ...
            >
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            ...
                            <ul className="flex flex-col gap-2">
                                {links.map((link) => (
                                    <li key={link.label}>
                                        <Button variant="ghost-badminton" size="sm" className="h-auto justify-start px-0 py-1 text-sm font-normal text-muted-foreground hover:text-primary" asChild>
                ...
                <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-8 md:flex-row">
                    <p className="text-sm text-muted-foreground">
                        &copy; 2026 BadmintonHub. Mọi quyền được bảo lưu.
                    </p>
                    <div className="flex items-center gap-4">
                        <Button variant="ghost-badminton" size="icon-sm" aria-label="Facebook" asChild>
                        ...
                        <Button variant="ghost-badminton" size="icon-sm" aria-label="YouTube" asChild>
                            <Link href="#" target="_blank" rel="noopener noreferrer">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <Button variant="ghost-badminton" size="icon-sm" aria-label="Zalo" asChild>
                            <Link href="#" target="_blank" rel="noopener noreferrer">
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
